...
{
  return visualInverseSolverUsingGeometry(manipulator, tool_name, target, goal_joint_value, goal_orientation);
}
...
bool SolverUsingCRAndGeometry::visualInverseSolverUsingGeometry(
