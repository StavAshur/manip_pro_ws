...
class OpenManipulatorController
{
  ...
  *****************************************************************************/
  ...
  ros::ServiceServer visual_goal_task_space_path_server_;
  ros::ServiceServer visual_goal_task_space_path_with_orientation_server_;
  ...
  bool visualGoalTaskSpacePathCallback(open_manipulator_msgs::SetKinematicsPose::Request  &req,
                                       open_manipulator_msgs::SetKinematicsPose::Response &res);

  bool visualGoalTaskSpacePathWithOrientationCallback(open_manipulator_msgs::SetKinematicsPose::Request  &req,
                                                      open_manipulator_msgs::SetKinematicsPose::Response &res);
