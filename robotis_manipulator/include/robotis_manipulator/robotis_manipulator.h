...
public:
  ...
  *****************************************************************************/
  ...
  bool makeTaskTrajectory(Name tool_name, std::vector<Eigen::Vector3d> target, double move_time, std::vector<JointValue> present_joint_value = {});
  bool makeTaskTrajectory(Name tool_name, std::vector<Eigen::Vector3d> target, Eigen::Matrix3d goal_orientation, double move_time, std::vector<JointValue> present_joint_value = {});
